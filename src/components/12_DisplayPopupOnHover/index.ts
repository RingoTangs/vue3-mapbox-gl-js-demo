...
const placesGeoJsonSource: mapboxgl.GeoJSONSourceRaw = {
    type: 'geojson',
    data: {
...
const addPlacesSource = (map: mapboxgl.Map, id?: string) => {
    id || (id = 'places-source')
    map.addSource(id, placesGeoJsonSource)
    return id
}

const addPlacesLayer = (map: mapboxgl.Map, sourceId: string, id?: string) => {
    id || (id = 'places-layer')
    map.addLayer({
        id,
        type: 'circle',
...
export { addPlacesSource, addPlacesLayer }
